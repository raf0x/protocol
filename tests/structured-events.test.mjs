...
test('protocol save uses the date-aware structured wrapper RPC', async () => { const c=client(); await mutations.saveProtocolWithEvents({protocolId:'p',name:'Plan',startDate:'2026-01-01',compounds:[],effectiveDate:'2026-09-10'},c); assert.equal(c.calls[0][0],'save_protocol_with_events_v2') })
