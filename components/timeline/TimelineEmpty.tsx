...
const content = {
  ...
  Weight: ['Your first weight is a starting point', 'Log a weight from Today to begin tracking changes over time.', '/protocol', 'Go to Today'],
  Journal: ['Make room for a check-in', 'Record how you feel, your sleep, or a note from Today.', '/protocol', 'Add a check-in'],
