...
fs.writeFileSync('components/dashboard/VialInventory.tsx', component, 'utf8');
console.log('Created VialInventory component');
...
// Add VialInventory after CompoundNotes
protocol = protocol.replace(
