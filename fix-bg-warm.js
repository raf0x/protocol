...
body {
  ...
  background-image:
    radial-gradient(ellipse 80% 50% at 15% 10%, rgba(139, 92, 246, 0.14) 0%, transparent 55%),
    radial-gradient(ellipse 60% 45% at 90% 20%, rgba(251, 191, 36, 0.08) 0%, transparent 50%),
    radial-gradient(ellipse 70% 55% at 85% 85%, rgba(139, 92, 246, 0.1) 0%, transparent 55%),
    radial-gradient(ellipse 80% 60% at 10% 90%, rgba(251, 191, 36, 0.06) 0%, transparent 55%),
...
body::before {
  ...
  background-image:
    ...
    radial-gradient(circle at 75% 70%, rgba(139, 92, 246, 0.04) 0%, transparent 35%);
  pointer-events: none;
  z-index: 0;
