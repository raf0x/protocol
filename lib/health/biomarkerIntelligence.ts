...
const definitions: MarkerDefinition[] = [
  ...
  { key: 'estradiol', category: 'Hormones', aliases: ['estradiol', 'e2', 'estradiol e2'] },
  ...
  { key: 'dht', category: 'Hormones', aliases: ['dht', 'dihydrotestosterone', 'dihydrotestosterone dht'] },
  { key: 'shbg', category: 'Hormones', aliases: ['shbg', 'sex hormone binding globulin', 'sex hormone binding globulin shbg'] },
  { key: 'lh', category: 'Hormones', aliases: ['lh', 'luteinizing hormone', 'luteinizing hormone lh'] },
  { key: 'fsh', category: 'Hormones', aliases: ['fsh', 'follicle stimulating hormone', 'follicle stimulating hormone fsh'] },
  { key: 'prolactin', category: 'Hormones', aliases: ['prolactin'] },
  { key: 'cortisol', category: 'Hormones', aliases: ['cortisol'] },
  { key: 'dhea-s', category: 'Hormones', aliases: ['dhea sulfate', 'dhea s', 'dehydroepiandrosterone sulfate'] },
  { key: 'testosterone-unspecified', category: 'Hormones', aliases: ['testosterone'] },
  { key: 'testosterone-bioavailable', category: 'Hormones', aliases: ['testosterone bioavailable', 'bioavailable testosterone'] },
  ...
  { key: 'ldl-small', category: 'Lipids', aliases: ['ldl small'] },
  { key: 'ldl-medium', category: 'Lipids', aliases: ['ldl medium'] },
  { key: 'ldl-peak-size', category: 'Lipids', aliases: ['ldl peak size'] },
  { key: 'hdl-large', category: 'Lipids', aliases: ['hdl large'] },
  { key: 'non-hdl-c', category: 'Lipids', aliases: ['non hdl cholesterol', 'non hdl c'] },
  { key: 'cholesterol-hdl-ratio', category: 'Lipids', aliases: ['total cholesterol hdl ratio', 'cholesterol hdl ratio'] },
  { key: 'hdl-c', category: 'Lipids', aliases: ['hdl c', 'hdl cholesterol'] },
  { key: 'triglycerides', category: 'Lipids', aliases: ['triglycerides'] },
  { key: 'apob', category: 'Lipids', aliases: ['apob', 'apo b', 'apolipoprotein b', 'apolipoprotein b apob'] },
  ...
  { key: 'mcv', category: 'CBC / Blood', aliases: ['mcv', 'mean corpuscular volume'] },
  { key: 'mch', category: 'CBC / Blood', aliases: ['mch', 'mean corpuscular hemoglobin'] },
  { key: 'mchc', category: 'CBC / Blood', aliases: ['mchc', 'mean corpuscular hemoglobin concentration'] },
  { key: 'rdw', category: 'CBC / Blood', aliases: ['rdw', 'red cell distribution width', 'red blood cell distribution width'] },
